...
% Save console output into log file (Uncomment to use)
...
%%       TSK Classification (4th) Assignment 
%               (Classification.pdf)
%    High-dimensionality dataset classification
%   (Using the optimal values of parameters found)
% (Used code parts downloaded from the course's e-learning)

%% Author: Kyparissis Kyparissis 
%         ( University ID: 10346 )
% We use code parts from classification_simpleDataset.m
